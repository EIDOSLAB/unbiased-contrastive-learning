'''
Credits: https://github.com/akamaster/pytorch_resnet_cifar10/blob/master/resnet.py
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, pool_k=8):
        ...
        self.avgpool = nn.AvgPool2d(pool_k)
